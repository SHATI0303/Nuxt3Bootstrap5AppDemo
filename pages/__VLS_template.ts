...
const __VLS_22 = __VLS_21({ ...{}, src: ("https://www.pets-station.info/img/subimg/chihuahua_howto.jpg"), alt: ("チワワの画像"), width: ("300"), height: ("200"), style: ({}), }, ...__VLS_functionalComponentArgsRest(__VLS_21));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_20, typeof __VLS_22> & Record<string, unknown>) => void)({ ...{}, src: ("https://www.pets-station.info/img/subimg/chihuahua_howto.jpg"), alt: ("チワワの画像"), width: ("300"), height: ("200"), style: ({}), });
...
const __VLS_32 = __VLS_31({ ...{}, src: ("https://www.paws-foglio.jp/cwp/wp-content/uploads/2021/03/1e54fd0044908ff8626a1c39c42adc48-600x450.jpg"), alt: ("ロングコートチワワの画像"), width: ("300"), height: ("200"), style: ({}), }, ...__VLS_functionalComponentArgsRest(__VLS_31));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_30, typeof __VLS_32> & Record<string, unknown>) => void)({ ...{}, src: ("https://www.paws-foglio.jp/cwp/wp-content/uploads/2021/03/1e54fd0044908ff8626a1c39c42adc48-600x450.jpg"), alt: ("ロングコートチワワの画像"), width: ("300"), height: ("200"), style: ({}), });
